...
export default function RemoveCollobsPopup({ visible, handleChanges, title }) {
        ...
        <Modal
            ...
            <View style={styles.container}>
                ...
                <View style={styles.popup}>
                    ...
                    {/* <Text allowFontScaling={false} style={styles.content}>Are you sure you want to remove this collaborator? */}
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', marginTop: 20, }}>
                        ...
                        <Button
                            style={{ width: '40%', borderWidth: 1, borderColor: PINK_RED }}
                            mode='contained'
                            uppercase={false}
